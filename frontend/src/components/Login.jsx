  ...
  return (
    <div className="w-full max-w-md mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700 relative z-10 pt-4">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-lg max-h-lg pointer-events-none dark:hidden">
        <div className="absolute top-0 left-0 w-72 h-72 bg-blue-400/30 rounded-full mix-blend-multiply filter blur-[80px] animate-[blob_7s_infinite]"></div>
        <div className="absolute top-0 right-0 w-72 h-72 bg-purple-400/30 rounded-full mix-blend-multiply filter blur-[80px] animate-[blob_7s_infinite_2s]"></div>
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-pink-400/30 rounded-full mix-blend-multiply filter blur-[80px] animate-[blob_7s_infinite_4s]"></div>
      </div>

      <div className="text-center mb-10 relative z-10">
        <div className="relative inline-flex justify-center mb-6">
          <div className="absolute inset-0 bg-indigo-500/20 dark:bg-teal-500/20 blur-xl rounded-full animate-pulse"></div>
          <div className="relative p-4 bg-white dark:bg-zinc-900 border border-indigo-100 dark:border-zinc-800 rounded-3xl shadow-xl shadow-indigo-900/10 dark:shadow-black/50 transform -rotate-6 hover:rotate-0 transition-transform duration-500">
            <Hexagon
              size={40}
              strokeWidth={2}
      ...
      {/* Main Glass Card */}
      <div className="relative overflow-hidden rounded-[2.5rem] border transition-all duration-500 shadow-2xl shadow-indigo-900/10 bg-white/70 backdrop-blur-2xl border-white dark:bg-zinc-900/70 dark:border-zinc-800/80 dark:shadow-black/80">
        ...
        <div className="p-8 md:p-10 space-y-7">
          ...
          <div className="flex items-center w-full">
            <div className="flex-1 border-t-2 border-indigo-50 dark:border-zinc-800"></div>
            <span className="px-4 text-[10px] font-black uppercase tracking-widest text-indigo-300 dark:text-zinc-600">
              Or email
            </span>
            <div className="flex-1 border-t-2 border-indigo-50 dark:border-zinc-800"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="peer w-full pl-12 pr-5 pt-6 pb-2 rounded-2xl bg-indigo-50/50 dark:bg-zinc-950/50 border-2 border-transparent focus:border-indigo-500 dark:focus:border-teal-500 outline-none transition-all font-bold text-sm text-stone-900 dark:text-white focus:bg-white dark:focus:bg-zinc-900 shadow-inner"
                required
              />
              <label
                htmlFor="email"
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="peer w-full pl-12 pr-5 pt-6 pb-2 rounded-2xl bg-indigo-50/50 dark:bg-zinc-950/50 border-2 border-transparent focus:border-indigo-500 dark:focus:border-teal-500 outline-none transition-all font-black tracking-widest text-sm text-stone-900 dark:text-white focus:bg-white dark:focus:bg-zinc-900 shadow-inner"
                required
              />
              <label
                htmlFor="password"
